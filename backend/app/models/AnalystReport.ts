...
import { IHazardReport } from './HazardReport';
...
const AnalystReport = mongoose.models.AnalystReport || mongoose.model<IAnalystReport>('AnalystReport', AnalystReportSchema);
