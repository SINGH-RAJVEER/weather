...
export const RollingStats: React.FC<RollingStatsProps> = ({
  ...
  if (isLoading || !displayedStats || !previousStats) {
    return (
      <div
        className={`overflow-hidden py-1 stats-strip-background ${className || ""}`}
      >
  ...
  return (
    <div
      className={`overflow-hidden py-1 stats-strip-background border-b ${className || ""}`}
    >
      <div className="flex w-max animate-roll">
        {statCards.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-xs font-normal text-neutral-500 ml-2">
                {stat.title}
              </p>
              <p className="text-sm font-semibold text-neutral-800 ml-2">
                {stat.value}
              </p>
