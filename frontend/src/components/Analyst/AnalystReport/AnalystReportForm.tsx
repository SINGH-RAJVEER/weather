...
import LocationSelection, { LocationData } from "./LocationSelection";
...
export const AnalystReportForm: React.FC<OfficialReportFormProps> = ({
  onSubmit,
}) => {
  const { user } = useAuth();
  ...
  const generateReport = async () => {
    ...
    const generatedData = {
      ...
      summary: `Current analysis of ocean conditions in ${
        location.city
      } indicates ${
