...
const SeverityIcon: React.FC<{ level: PublicAdvisory["severityLevel"] }> = ({
  level,
}) => {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
              <h3 className="font-extrabold text-[15px] leading-tight truncate">
                {top.title}
              </h3>
              <span className="text-xs text-neutral-600">
                Issued by {top.issuedBy} ·{" "}
                {new Date(top.issuedAt).toLocaleString()}
              </span>
            </div>
            ...
            <div className="relative mt-2">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, var(--card-bg), rgba(244,248,251,0))",
                }}
              />
            </div>
          </div>
