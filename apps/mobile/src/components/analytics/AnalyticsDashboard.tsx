import { AlertTriangle, BarChart3, Calendar, MapPin, TrendingUp, Users } from "lucide-react-native";
    ...
    <ScrollView className="space-y-6 p-4 bg-neutral-50">
      ...
      <View className="flex-row flex-wrap justify-between">
        ...
        <View className="w-[48%] bg-white p-4 rounded-lg mb-4">
          <View className="flex-row items-center space-x-3">
            ...
            <View>
              <Text className="text-sm font-medium text-neutral-600">Total Reports</Text>
              <Text className="text-2xl font-bold text-neutral-900">1,247</Text>
              <Text className="text-xs text-green-600 font-medium">+15% from last month</Text>
            </View>
          </View>
        </View>
        ...
        <View className="w-[48%] bg-white p-4 rounded-lg mb-4">
          <View className="flex-row items-center space-x-3">
            ...
            <View>
              <Text className="text-sm font-medium text-neutral-600">Verification Rate</Text>
              <Text className="text-2xl font-bold text-neutral-900">73%</Text>
              <Text className="text-xs text-green-600 font-medium">+5% improvement</Text>
            </View>
          </View>
        </View>
        ...
        <View className="w-[48%] bg-white p-4 rounded-lg mb-4">
          <View className="flex-row items-center space-x-3">
            ...
            <View>
              <Text className="text-sm font-medium text-neutral-600">Active Users</Text>
              <Text className="text-2xl font-bold text-neutral-900">8,456</Text>
              <Text className="text-xs text-green-600 font-medium">+8% growth</Text>
            </View>
          </View>
        </View>
        ...
        <View className="w-[48%] bg-white p-4 rounded-lg mb-4">
          <View className="flex-row items-center space-x-3">
            ...
            <View>
              <Text className="text-sm font-medium text-neutral-600">Active Hazards</Text>
              <Text className="text-2xl font-bold text-neutral-900">12</Text>
              <Text className="text-xs text-red-600 font-medium">+3 since yesterday</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View className="bg-white p-4 rounded-lg">
        <View className="flex-row items-center mb-4">
          ...
          <Text className="ml-2 text-lg font-semibold text-neutral-900">Severity Distribution</Text>
        </View>
        <PieChart
          data={severityData.map((s, _i) => ({
            name: s.name,
            population: s.value,
            color: s.color,
      ...
      <View className="bg-white p-4 rounded-lg">
        <View className="flex-row items-center mb-4">
          ...
          <Text className="ml-2 text-lg font-semibold text-neutral-900">Reports by Region</Text>
        </View>
        <BarChart
          data={{
      ...
      <View className="bg-white p-4 rounded-lg">
        <View className="flex-row items-center mb-4">
          ...
          <Text className="ml-2 text-lg font-semibold text-neutral-900">Daily Activity</Text>
        </View>
        <LineChart
          data={{
            labels: mockHazardData.map((d) => d.name),
      ...
      <View className="bg-white p-4 rounded-lg">
        <Text className="text-lg font-semibold text-neutral-900 mb-4">Recent Activity Summary</Text>
        {[
          {
            date: "2024-01-15",
            region: "Chennai",
          ...
          <View key={idx} className="p-3 mb-3 border border-neutral-200 rounded-lg">
