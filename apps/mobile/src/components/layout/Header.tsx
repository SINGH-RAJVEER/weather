...
import { LogOut, MapPin, Settings, User } from "lucide-react-native";
        ...
        <View className="flex-row items-center">
          ...
          <View className="flex-row items-center">
            <View className="items-end mr-3">
              ...
              <Text className="text-xs text-cyan-300 capitalize">{user?.role}</Text>
            </View>
          ...
          {filteredNavItems.map((item) => (
            ...
            >
              <Text
                ...
                numberOfLines={1}
              >
                {item.id === "map" && user?.role === "official" ? "Live Risk Score" : item.label}
              </Text>
            </Pressable>
          ))}
        </View>
