  ...
  return (
    <View className="flex-1 bg-neutral-50">
      ...
      <View className="flex-row items-center p-4 border-b border-neutral-200 bg-white">
        <TouchableOpacity onPress={onBack} className="mr-4 p-2 rounded-lg bg-neutral-100">
          <ArrowLeft size={20} color="#374151" />
        </TouchableOpacity>
        <Text className="text-2xl font-semibold text-neutral-900 flex-1">All Reports</Text>
      </View>
            ...
            >
              ...
              <View className="flex-row items-start mb-3">
                ...
                <View className="ml-3 flex-1">
                  ...
                  <Text className="text-sm text-neutral-600">{report.description}</Text>
                </View>
              </View>
              ...
              <View className="space-y-4">
                ...
                <View className="flex-row items-center">
                  ...
                  <Text className="text-xs text-neutral-500 ml-1" numberOfLines={1}>
                ...
                <View className="flex-row justify-between items-center">
                  ...
                  <View className="flex-row items-center">
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-xs text-neutral-500 ml-1">{report.likes}</Text>
                    </View>
                    <View className="flex-row items-center" style={{ marginLeft: 6 }}>
                      <MessageCircle size={12} color="#6b7280" />
                      <Text className="text-xs text-neutral-500 ml-1">{report.comments}</Text>
                    </View>
                  </View>
                </View>
              </View>
