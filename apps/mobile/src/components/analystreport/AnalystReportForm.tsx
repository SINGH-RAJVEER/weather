import { ArrowLeft, FileText, Loader, MapPin, Target } from "lucide-react-native";
import { useState } from "react";
import { ScrollView, Text, TextInput, TouchableOpacity, View } from "react-native";
import saveAnalystReport from "../../api/analystReport";
import { useAuth } from "../../contexts/AuthContext";

interface AnalystReportFormProps {
...
export default function AnalystReportForm({ onSubmit }: AnalystReportFormProps) {
  const { user } = useAuth();
      ...
      <ScrollView className="p-4 space-y-6">
        <View className="bg-white p-4 rounded-xl shadow">
          ...
          <View className="flex-row items-center mb-6">
            ...
            <View>
              <Text className="text-xl font-bold text-neutral-900">Generate Report</Text>
          ...
          {/* Search */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Search Location</Text>
          <View className="relative mb-6">
            <Target size={16} color="#9ca3af" style={{ position: "absolute", top: 14, left: 10 }} />
            <TextInput
              value={searchTerm}
              ...
              return (
                ...
                >
                  <View className="flex-row justify-between items-center mb-3">
                    <View>
                      <Text className="font-semibold text-neutral-900">{location.city}</Text>
                      <Text className="text-sm text-neutral-600">{location.state}</Text>
                    </View>
                    <Text
      ...
      <ScrollView className="p-4 space-y-6">
        <View className="bg-white p-4 rounded-xl shadow">
          ...
          <View className="flex-row items-center mb-6">
            ...
            <View>
              <Text className="text-xl font-bold text-neutral-900">Complete Report</Text>
              <Text className="text-sm text-neutral-600">
          ...
          {/* Title */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Report Title</Text>
          <TextInput
          ...
          {/* Date & Time */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Date & Time</Text>
          <TextInput
          ...
          {/* Hazards */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Identified Hazards</Text>
          <TextInput
          ...
          {/* Impact Assessment */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Impact Assessment</Text>
          <TextInput
          ...
          {/* Recommendations */}
          <Text className="text-sm font-medium text-neutral-700 mb-2">Recommendations</Text>
          <TextInput
