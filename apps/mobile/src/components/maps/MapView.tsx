...
const MapViewComponent = ({ reports, isLoading }: MapViewProps) => {
  const [_activeReport, setActiveReport] = useState(null);
          ...
          >
            ...
            <Callout tooltip>
              <View className="bg-white p-3 rounded-lg shadow border border-neutral-200 w-64">
                ...
                <Text className="text-xs text-neutral-600 mb-1">{report.description}</Text>
                <Text className="text-xs text-neutral-500">{report.location.address}</Text>
