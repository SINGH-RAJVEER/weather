import { type IPublicAdvisory, PublicAdvisory } from "@weather/database";
...
router.get("/:id", getAdvisory, (_req: Request, res: ResponseWithAdvisory) => {
...
// DELETE an advisory
router.delete("/:id", getAdvisory, async (_req: Request, res: ResponseWithAdvisory) => {
  try {
