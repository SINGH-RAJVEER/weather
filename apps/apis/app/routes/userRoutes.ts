...
import { User } from "@weather/database";
...
const storage = multer.diskStorage({
  destination: (_req: AuthRequest, _file: any, cb: any) => {
...
router.post(
  "/profile-picture",
  (req: AuthRequest, res: Response, next: NextFunction) => getAuth().middleware()(req, res, next),
