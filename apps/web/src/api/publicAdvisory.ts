...
const mapPublicAdvisory = (a: any): PublicAdvisory => {
  return {
    ...
    targetRegions: Array.isArray(a.targetRegions) ? (a.targetRegions as string[]) : [],
    severityLevel: (a.severityLevel as PublicAdvisory["severityLevel"]) ?? "info",
    validUntil: a.validUntil
      ? typeof a.validUntil === "string"
        ? a.validUntil
        : new Date(a.validUntil).toISOString()
      : undefined,
    attachments: Array.isArray(a.attachments) ? (a.attachments as string[]) : [],
